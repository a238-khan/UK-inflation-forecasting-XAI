...
- Ensemble training saves artifacts under `results/hybrid_b/` (models, feature names, stacked test features).
...
2. `notebooks/05_ensemble_methods.ipynb`: run the pipeline cell to train Hybrid B and save artifacts.
